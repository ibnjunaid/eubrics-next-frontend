  ...
  return (
    <div className="navbar bg-base-100">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            ...
            <li>
              <a
                href="https://github.com/ibnjunaid"
                target={"_blank"}
                rel="noreferrer"
              >
                Github
            ...
            <li>
              <a
                href="https://linkedin.com/in/ibnjunaid"
                target={"_blank"}
                rel="noreferrer"
              >
                LinkedIn
      ...
      <div className="navbar-end mr-5 gap-10">
        {
          context?.userCred?.username ? <h1>Hello ! {context.userCred.username} </h1> : null
        }
        {context?.userCred?.access_token ? (
          <button className="btn gap-2" onClick={() => {
            context.setUserCred(null);
            router.push('/');
          }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
